...
var _useMoralisWeb3 = function (Moralis) {
    ...
    useEffect(function () {
        ...
        var unsubChainChanged = Moralis.onChainChanged(setChainId);
...
var MoralisProvider = function (_a) {
    ...
    var _d = _useMoralisWeb3(moralisInit.Moralis), _setIsWeb3Enabled = _d._setIsWeb3Enabled, _setIsWeb3EnableLoading = _d._setIsWeb3EnableLoading, moralisWeb3 = __rest(_d, ["_setIsWeb3Enabled", "_setIsWeb3EnableLoading"]);
    var _e = _useMoralisUser(moralisInit.Moralis), setUser = _e.setUser, moralisUser = __rest(_e, ["setUser"]);
...
export { ByMoralis, MoralisContext, MoralisProvider, NoMoralisContextProviderError, NotAuthenticatedError, ReactMoralisError, ValidationError, getChain, getSupportedChains, resolveIPFS, useApiContract, useChain, useERC20Balances, useERC20Transfers, useFiatBuy, useMoralis, useMoralisCloudFunction, useMoralisFile, useMoralisQuery, useMoralisSolanaApi, useMoralisSolanaCall, useMoralisSubscription, useMoralisWeb3Api, useMoralisWeb3ApiCall, useNFTBalances, useNFTTransfers, useNativeBalance, useNativeTransactions, useNewMoralisObject, useOneInchQuote, useOneInchSwap, useOneInchTokens, useOpenSeaAsset, useOpenSeaBuyOrder, useOpenSeaOrders, useOpenSeaSellOrder, useRaribleLazyMint, useRaribleSellOrder, useTokenPrice, useWeb3Contract, useWeb3ExecuteFunction, useWeb3Transfer };
